...
inline u64 umul128(const u64 a, const u64 b, u64* const productHi) {
  return _umul128(a, b, productHi);
}

inline u64 shiftright128(const u64 lo, const u64 hi, const uint32_t dist) {
...
inline u64 umulh(const u64 a, const u64 b) {
...
inline u64 div5(const u64 x) {
  return umulh(x, 0xCCCCCCCCCCCCCCCDu) >> 2;
}

inline u64 div10(const u64 x) {
  return umulh(x, 0xCCCCCCCCCCCCCCCDu) >> 3;
}

inline u64 div100(const u64 x) {
  return umulh(x >> 2, 0x28F5C28F5C28F5C3u) >> 2;
}

inline u64 div1e8(const u64 x) {
  return umulh(x, 0xABCC77118461CEFDu) >> 26;
}

inline u64 div1e9(const u64 x) {
  return umulh(x >> 9, 0x44B82FA09B5A53u) >> 11;
}

inline uint32_t mod1e9(const u64 x) {
...
inline uint32_t pow5Factor(u64 value) {
  uint32_t count = 0;
  for (;;) {
    BOOST_ASSERT(value != 0);
    const u64 q = div5(value);
...
inline bool multipleOfPowerOf5(const u64 value, const uint32_t p) {
  // I tried a case distinction on p, but there was no performance difference.
  return pow5Factor(value) >= p;
}

// Returns true if value is divisible by 2^p.
inline bool multipleOfPowerOf2(const u64 value, const uint32_t p) {
  BOOST_ASSERT(value != 0);
