...
public:
     ...
     */
    std::u64 affected_rows() const noexcept { return impl_.get_interface().get_affected_rows(); }
     ...
     * `this->complete() == true || this->should_read_head() == true`
     */
    std::u64 last_insert_id() const noexcept { return impl_.get_interface().get_last_insert_id(); }
