...
uint8_t emscripten_atomic_exchange_uint8_t(void/*uint8_t*/ *addr __attribute__((nonnull)), uint8_t newVal);
...
uint8_t emscripten_atomic_cas_uint8_t(void/*uint8_t*/ *addr __attribute__((nonnull)), uint8_t oldVal, uint8_t newVal);
...
uint8_t emscripten_atomic_load_uint8_t(const void/*uint8_t*/ *addr __attribute__((nonnull)));
...
uint8_t emscripten_atomic_store_uint8_t(void/*uint8_t*/ *addr __attribute__((nonnull)), uint8_t val);
...
uint8_t emscripten_atomic_add_uint8_t(void/*uint8_t*/ *addr __attribute__((nonnull)), uint8_t val);
...
uint8_t emscripten_atomic_sub_uint8_t(void/*uint8_t*/ *addr __attribute__((nonnull)), uint8_t val);
...
uint8_t emscripten_atomic_and_uint8_t(void/*uint8_t*/ *addr __attribute__((nonnull)), uint8_t val);
...
uint8_t emscripten_atomic_or_uint8_t(void/*uint8_t*/ *addr __attribute__((nonnull)), uint8_t val);
...
uint8_t emscripten_atomic_xor_uint8_t(void/*uint8_t*/ *addr __attribute__((nonnull)), uint8_t val);
