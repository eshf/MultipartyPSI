...
namespace __gnu_parallel
{
  ...
  private:
    ...
    static u32
    __scale_down(u64 __x,
#if _GLIBCXX_SCALE_DOWN_FPU
               u64 /*_M_supremum*/, double _M_supremum_reciprocal)
#else
               u64 _M_supremum, double /*_M_supremum_reciprocal*/)
#endif
        {
#if _GLIBCXX_SCALE_DOWN_FPU
          return u32(__x * _M_supremum_reciprocal);
#else
          return static_cast<u32>(__x % _M_supremum);
#endif
        }
  ...
  public:
    ...
    : _M_mt(0), _M_supremum(0x100000000ULL),
      _M_rand_sup(1ULL << std::numeric_limits<u32>::digits),
    ...
    _RandomNumber(u32 __seed, u64 _M_supremum = 0x100000000ULL)
